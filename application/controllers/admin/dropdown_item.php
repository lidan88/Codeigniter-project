...
class Dropdown_item extends CI_Controller
{
	...
	function add($dropdown_id = 0)
	{
		...
		$this->load->view("admin/add/add_dropdown_item",$data);	
	}
	...
	function edit($item_id = 0)
	{
		...
		$this->load->view("admin/edit/edit_dropdown_item",$data);	
	}
	...
	function main($dropdown_id = 0)
	{
		...
		$data['pagination'] = $this->dropdown_item_lib->display_pagination('/admin/dropdown_item/main/',$page,'dropdown_item.dropdown_id='.$dropdown_id); 
	
		$data['list'] = $list;
	
		$this->load->view("admin/main/main_dropdown_item",$data);
	}
	
	function view()
	{
		$this->load->view("admin/view/view_dropdown_item");	
	}
	...
	function do_add()
	{
		...
		//echo "Added";
		redirect("/admin/dropdown_item/main/".$dropdown_id);
	}
	...
	function do_delete($dropdown_item_id)
	{
		...
		//echo "Deleted"; 
		redirect("/admin/dropdown_item/main/");
	}

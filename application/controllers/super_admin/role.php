...
class Role extends CI_Controller
{
	...
	{
		$this->load->database();
		$this->load->view("super_admin/add/add_role");	
	}
	...
	function edit($item_id = 0)
	{
		...
		$this->load->view("super_admin/edit/edit_role",$data);	
	}
	...
	function main($page = 0)
	{
		...
		$list = $this->role_lib->get_list($page,'company_id=0',$sort,$ord);
	
		$data['pagination'] = $this->role_lib->display_pagination('/super_admin/role/main/',$page); 
	
		$data['list'] = $list;
	
		$this->load->view("super_admin/main/main_role",$data);
	}
	
	function view()
	{
		$this->load->view("super_admin/view/view_role");	
	}

<?
$limit=30;
$sort=isset($_REQUEST['sort'])?$_REQUEST['sort']:"role_id";
...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
		...
		<div class="bread-crumb pull-left">
		  ...
		  <span class="divider">/</span> 
		  <a href="/super_admin/role/add/"> &raquo; Add New</a>
		</div>
						...
						<div class="widget">
			                ...
			                <div class="widget-content">
								...
								<td class="rowHeader"><?                 
					                ...
					                ?>Name</a></td>
					                <td class="rowHeader">Permissions</td>
	...
	<td align="left" valign="top" class="rowDark"><?=isset($row['fname'])?$row['fname']:$row['name']?></td>
			                	            <td align="center" valign="top" class="rowDark"><a href="/super_admin/role_permission/main/<?=$row['role_id']?>/">Manage Permissions</a></td>
			                	            	<td align="center" valign="top" class="rowDark">
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-warning" href="/super_admin/role/edit/<?=$row['role_id']?>/"><i class="icon-pencil"></i> </a>
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-danger" href="javascript:confirm_delete('/super_admin/role/do_delete/<?=$row['role_id']?>/');"><i class="icon-remove"></i></a>
			                	            	</td>
			                	            </tr>
			                	        <? 	
			                	            }

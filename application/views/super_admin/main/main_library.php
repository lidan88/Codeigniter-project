...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
		...
		<div class="bread-crumb pull-left">
		  ...
		  <span class="divider">/</span> 
		  <a href="/super_admin/library/add/"> &raquo; Add New</a>
		</div>
	...
	<td align="left" valign="top" style="<?=($row['is_system']==1?'color: red;':'')?>"><?=$row['name']?> <?=($row['is_system']==1?'*':'')?></td>
	<td align="left" valign="top" class="rowDark"><a href="/super_admin/library_items/main/<?=$row['id']?>">Manage Fields</a></td>
			                	            
			                	            	<td align="center" valign="top" class="rowDark">
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-warning" href="/super_admin/library/edit/<?=$row['id']?>/"><i class="icon-pencil"></i> </a>
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-danger" href="javascript:confirm_delete('/super_admin/library/do_delete/<?=$row['id']?>/');"><i class="icon-remove"></i></a>
			                	            	</td>
			                	            </tr>
			                	        <? 	
			                	            }

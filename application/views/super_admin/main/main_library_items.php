...
$(document).ready(function(){
	...
	$("#sort tbody").sortable({
		...
		{
			$.post("/super_admin/library_items/set_sort_order/",{"sort_order":sort_order.join(',')},function(ret){
				console.log(ret);
			});
		}
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
		...
		<div class="bread-crumb pull-left">
		  ...
		  <span class="divider">/</span> 
		  <a href="/super_admin/library_items/main/<?=$library_details['id']?>" class="bread-current"><?=$library_details['name']?> </a>
		  <span class="divider">/</span> 
		  
		  <a href="/super_admin/library_items/add/<?=$library_details['id']?>"> &raquo; Add New Field</a>
		</div>
			                	        ...
			                	        foreach($list as $item_name => $row)
			                	        {
			                	        	...
			                	        	<tr id="item_<?=$row['id']?>">
			                	        		...
			                	        		<td align="center" valign="top" class="rowDark">
			                	        			<a style="text-decoration:none" class="btn btn-xs btn-warning" href="/super_admin/library_items/edit/<?=$row['id']?>/"><i class="icon-pencil"></i> </a>
			                	        			<a style="text-decoration:none" class="btn btn-xs btn-danger" href="javascript:confirm_delete('/super_admin/library_items/do_delete/<?=$row['id']?>/');"><i class="icon-remove"></i></a>
			                	        		</td>
			                	        	</tr>

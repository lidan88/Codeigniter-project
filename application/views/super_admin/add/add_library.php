    ...
    <!-- Sidebar ends -->
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-left">
          ...
          <a href="/super_admin/library/main/"> View All Library </a>
          <span class="divider">/</span> 
	          	            ...
	          	            <div class="col-md-12">
	          	              ...
	          	              <div class="widget wgreen">
	          	                ...
	          	                <div class="widget-head">
	          	                  <div class="pull-left">Add New Library</div>
	          	                ...
	          	                <div class="widget-content">
	          	                  <div class="padd">
	          	                    ...
	          	                    <!-- Form starts.  -->
	          	                     <form class='form-horizontal' name='frm_add_library' method='post' action='/super_admin/library/do_add/' onSubmit='return form_validation(this);' enctype='multipart/form-data'>
		          	                     <table class="table table-bordered table-striped table-hover content" style="width:100%;" cellpadding="0" cellspacing="0"><input type='hidden' id='chaabee_post' name='chaabee_post' value=''><input type='hidden' id='id' name='id' value=''><tr>
											...
											<!--tr>
												...
												<td width='65%' class='capitalize'><input name="is_system" type="radio" id="rstatus" value="1" />&nbsp;Yes&nbsp;<input name="is_system" type="radio" id="rstatus" value="0" checked="checked" />&nbsp;No&nbsp;</td>
											</tr!-->
											<tr>
												<td width='35%' class='capitalize'  valign='top' align='left'>Is Visible:</td>
												<td width='65%' class='capitalize'><input name="is_visible" type="radio" id="rstatus" value="1" checked="checked" />&nbsp;Yes&nbsp;<input name="is_visible" type="radio" id="rstatus" value="0" />&nbsp;No&nbsp;</td>
											</tr>

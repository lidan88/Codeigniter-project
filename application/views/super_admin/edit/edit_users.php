    ...
    <!-- Sidebar ends -->
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-left">
          ...
          <a href="/super_admin/users/main/<?=$company_id?>/"><?=$company_details['name']?></a>
          <span class="divider">/</span> 
          <a href="/super_admin/users/main/<?=$company_id?>/">Users</a>
          <span class="divider">/</span> 
	          	            ...
	          	            <div class="col-md-12">
	          	              <div class="widget wgreen">
	          	                <div class="widget-head">
	          	                  <div class="pull-left">Edit users</div>
	          	                ...
	          	                <div class="widget-content">
	          	                  <div class="padd">
	          	                    ...
	          	                    <!-- Form starts.  -->
	          	                     <form class='form-horizontal' name='frm_edit_users' method='post' action='/super_admin/users/do_update/<?=$item['user_id']?>' onSubmit='return form_validation(this);' enctype='multipart/form-data'>
	          	                     ...
	          	                     <tr>
										<td width='35%' class='capitalize' valign='top' align='left'>Company :</td>
										<td width='65%' class='capitalize'><?=$company_details['name']?></td></tr><tr>
									...
									<tr>
										...
										if($res->num_rows()>0)
										{
											foreach ($res->result_array() as $data)
											{
												echo "<option value='".$data['timezone']."' ".((isset($item) and $item['timezone']==$data['timezone'])?'selected="selected"':"").">".$data['timezone'].' - '.$data['name']."</option>";
											}
										}
										?></select>
										</td>
									...
									<tr>
										...
										<td width='65%' class='capitalize'><input  class='form-control ' type='text' size=40 name='first_name'  value='<?=$item['first_name']?>'  /></td></tr><tr>
										...
										<td width='65%' class='capitalize'><input  class='form-control ' type='text' size=40 name='aemail'  value='<?=$item['aemail']?>'  /></td></tr><tr>
										...
										<td width='65%' class='capitalize'><input name="status" type="radio" id="rstatus" value="ACTIVE" <? if(isset($item)){ if($item['status']=='ACTIVE')echo 'checked="checked"'; } ?> />&nbsp;ACTIVE&nbsp;<input name="status" type="radio" id="rstatus" value="INACTIVE" <? if(isset($item)){ if($item['status']=='INACTIVE')echo 'checked="checked"'; } ?> />&nbsp;INACTIVE&nbsp;</td>
									</tr>
												
						<tr>
							<td class='capitalize' width='35%'>&nbsp;</td>
							<td width='65%' class='capitalize'><input name='Submit' id='Submit' class="btn btn-danger" type='submit' value='Update' />
							</td>
						</tr></table></form>

      	            ...
      	            <div class="col-md-12">
      	              <div class="widget wgreen">
      	                <div class="widget-head">
      	                  <div class="pull-left">Edit threats</div>
      	                ...
      	                <div class="widget-content">
      	                  <div class="padd">
      	                    ...
      	                    <!-- Form starts.  -->
      	                     <form class='form-horizontal' name='frm_edit_threats' method='post' action='/super_admin/threats/do_update/<?=$item['threat_id']?>' onSubmit='return form_validation(this);' enctype='multipart/form-data'>
      	                     	<table class="table table-bordered table-striped table-hover content" style="width:100%;" cellpadding="0" cellspacing="0">
          	                     	...
          	                     	<input type='hidden' id='threat_id' name='threat_id' value='<?=$item['threat_id']?>'>
									<tr>
									...
									<tr>
										...
										<td width='65%' class='capitalize'><input  class='form-control ' type='text' size=40 id="group" name='group'  value='<?=$item['group']?>' />

	          	            ...
	          	            <div class="col-md-12">
	          	              <div class="widget wgreen">
	          	                ...
	          	                <div class="widget-content">
	          	                  <div class="padd">
	          	                    <!-- Form starts.  -->
	          	                     <form class='form-horizontal' name='frm_edit_library' method='post' action='/super_admin/library/do_update/<?=$item['id']?>' onSubmit='return form_validation(this);' enctype='multipart/form-data'>

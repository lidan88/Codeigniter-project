    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
		...
		<div class="bread-crumb pull-left">
		  ...
		  <span class="divider">/</span> 
		  <a href="/admin/library/add/"> &raquo; Add New</a>
		</div>
						...
						<div class="widget">
			                ...
			                <div class="widget-content">
			                	<table class="table table-striped table-bordered table-hover">
									...
									<!--<td class="rowHeader">Data Entry</td>-->
			                	    ...
			                	    <?                
			                	        ...
			                	        ?>
			                	            <tr>
												...
												<!--<td align="left" valign="top" class="rowDark"><a href="/admin/library_items/enter_user_data/<?=$row['id']?>">Enter Data</a></td>-->

...
<div style="border: 3px solid #333; width: 100%; height: 100%;">
	<div style="text-align: center; width: 500px;margin: 0 auto; border-bottom: 1px solid #333; margin-top: 30%;">
		<h1 style="margin: 0px; font-size: 50px;"><?=$company['name']?></h1>
		<h1 style="margin: 0px;"><strong>Business Continuity Plan</strong></h1>
	</div>
	<div style="text-align: center; width: 500px; height: 60%;margin: 0 auto;">
		<br />
		<br />
		<h2 style="margin: 0px;">Plan Name: <?=$item['formated_info']['Name']?></h2><br />

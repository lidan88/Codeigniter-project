	          	              ...
	          	              <div class="widget wgreen">
	          	                ...
	          	                <div class="widget-content">
	          	                  <div class="padd">
	          	                    ...
	          	                    <!-- Form starts.  -->
	          	                     <form class='form-horizontal' name='frm_add_library' method='post' action='/admin/library/do_add/' onSubmit='return form_validation(this);' enctype='multipart/form-data'>

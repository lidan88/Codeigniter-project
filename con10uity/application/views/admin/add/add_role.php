	          	              ...
	          	              <div class="widget wgreen">
	          	                ...
	          	                <div class="widget-content">
	          	                  <div class="padd">
	          	                    ...
	          	                    <!-- Form starts.  -->
	          	                     <form class='form-horizontal' name='frm_add_role' method='post' action='/admin/role/do_add/' onSubmit='return form_validation(this);' enctype='multipart/form-data'>
	          	                     ...
	          	                     <input type='hidden' id='role_id' name='role_id' value=''><tr>

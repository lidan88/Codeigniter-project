    ...
    <!-- Sidebar ends -->
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-left">
          ...
          <span class="divider">/</span> 
          <a href="#" class="bread-current"> &raquo; Add New Item</a>
        </div>
	          	              ...
	          	              <div class="widget wgreen">
	          	                ...
	          	                <div class="widget-content">
	          	                  <div class="padd">
	          	                    ...
	          	                    <!-- Form starts.  -->
	          	                     <form class='form-horizontal' name='frm_add_dropdown_item' method='post' action='/admin/dropdown_item/do_add/' onSubmit='return form_validation(this);' enctype='multipart/form-data'>
	          	                     ...
	          	                     <tr>
										...
										<td width='35%' class='capitalize'  valign='top' align='left'>Active:</td>
										<td width='65%' class='capitalize'>
											<input name="is_active" type="radio" id="ris_active" value="Yes" checked="checked" />&nbsp;Yes&nbsp;
											<input name="is_active" type="radio" id="ris_active" value="No"  />&nbsp;No&nbsp;</td></tr><tr><td class='capitalize' width='35%'>&nbsp;</td>
										<td width='65%' class='capitalize'><input name='Submit' id='Submit' class="btn btn-danger" type='submit' value='Add' />
										</td>
										</tr>
										</table>
									</form>

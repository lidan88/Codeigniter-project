...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
		...
		<div class="bread-crumb pull-left">
		  ...
		  <span class="divider">/</span> 
		  <a href="/admin/dropdown/add/"> &raquo; Add New</a>
		</div>
					...
					<div class="col-md-12">
						<div class="widget">
					        <div class="widget-head">
			                  <div class="pull-left">List of Dropdowns</div>
	...
	<td align="left" valign="top" class="rowDark"><?=isset($row['fis_active'])?$row['fis_active']:$row['is_active']?></td>
			                	            <td><a href="/admin/dropdown_item/main/<?=$row['dropdown_id']?>">Manage Items</a></td>
			                	            	<td align="center" valign="top" class="rowDark">
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-warning" href="/admin/dropdown/edit/<?=$row['dropdown_id']?>/"><i class="icon-pencil"></i> </a>
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-danger" href="javascript:confirm_delete('/admin/dropdown/do_delete/<?=$row['dropdown_id']?>/');"><i class="icon-remove"></i></a>
			                	            	</td>
			                	            </tr>
			                	        <? 	
			                	            }

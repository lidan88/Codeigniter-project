...
function delete_items()
{
	...
	if(p)
	{
		...
		{
			$.post("/admin/bia/do_delete_multi/",{"ids":searchIDs.join(",")},function(ret){
...
function edit_item()
{
	...
	if(searchIDs.length>0)
	{
		...
		{
			top.location="/admin/bia/edit/"+searchIDs[0];
		}
		else {
...
function copy_item()
{
	...
	if(searchIDs.length>0)
	{
		if(searchIDs.length==1)
		{
			$.post("/admin/bia/do_copy/",{"id":searchIDs[0]},function(ret){
...
function do_search(search) {
	$.post("/admin/bia/main/?output=ajax&search="+search,{},function(ret){
		var test = ret;
...
<?// if($CI->permission_lib->has_permission("library-bia","edit")){ ?>
$(document).ready(function(){
	$( "tr" ).dblclick(function() {
	  var item_no = $(this).attr('id').replace('item_no_', '');
	  top.location="/admin/bia/edit/"+item_no+"/";
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
		...
		<div class="bread-crumb pull-left">
		  ...
		  <a href="#" class="bread-current">BIA </a>
		  <span class="divider">/</span> 
		  <a href="/admin/bia/add/"> &raquo; Add New</a>
		</div>
					...
					<div class="col-md-12">
						<div class="widget">
					        <div class="widget-head">
			                  <div class="pull-left">Business Impact Analysis</div>
			                  <div class="pull-left" style="margin-left: 20px;">
			                  
			                  	<? //if($CI->permission_lib->has_permission("library-bia","add")){ ?>
			                  	<a href="/admin/bia/add/" class="btn btn-mini btn-primary">Add</a>
			                  	<? //} ?>
			                  	<? //if($CI->permission_lib->has_permission("library-bia","edit")){ ?>
			                  	...
			                  	<? //} ?>
			                  	<? //if($CI->permission_lib->has_permission("library-bia","delete")){ ?>

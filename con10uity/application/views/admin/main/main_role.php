...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
		...
		<div class="bread-crumb pull-left">
		  ...
		  <span class="divider">/</span> 
		  <a href="/admin/role/add/"> &raquo; Add New</a>
		</div>
	...
	<td align="left" valign="top" class="rowDark"><?=isset($row['fname'])?$row['fname']:$row['name']?></td>
			                	            <td align="center" valign="top" class="rowDark"><a href="/admin/role_permission/main/<?=$row['role_id']?>/">Manage Permissions</a></td>
			                	            	<td align="center" valign="top" class="rowDark">
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-warning" href="/admin/role/edit/<?=$row['role_id']?>/"><i class="icon-pencil"></i> </a>
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-danger" href="javascript:confirm_delete('/admin/role/do_delete/<?=$row['role_id']?>/');"><i class="icon-remove"></i></a>
			                	            	</td>
			                	            </tr>
			                	        <? 	
			                	            }

...
function do_search(search) {
	$.post("/admin/reports/main/?output=ajax&search="+search,{},function(ret){
		var test = ret;
...
$(document).ready(function(){
	$( "tr" ).dblclick(function() {
	  ...
	  top.location="/admin/reports/edit/"+item_no+"/";
						...
						<div class="widget">
					        <div class="widget-head">
			                  ...
			                  <div class="pull-left" style="margin-left: 20px;">
			                  	...
			                  	<a href="/admin/reports/add/" class="btn btn-mini btn-primary">Add</a>

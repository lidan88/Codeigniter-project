    ...
    <!-- Sidebar ends -->
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-left">
          ...
          <a href="/admin/users/main/<?=$company_id?>/"><?=$company_details['name']?></a>
          <span class="divider">/</span> 
          <a href="/admin/users/main/<?=$company_id?>/">Users</a>
          <span class="divider">/</span> 
          	              ...
          	              <div class="widget wgreen">
          	                ...
          	                <div class="widget-content">
          	                  <div class="padd">
          	                    ...
          	                    <!-- Form starts.  -->
          	                     <form class='form-horizontal' name='frm_edit_users' method='post' action='/admin/users/do_update/<?=$item['user_id']?>' onSubmit='return form_validation(this);' enctype='multipart/form-data'>
								...
								<td width='65%' class='capitalize'>
									<input  class='form-control ' type='password' size=40 name='password' id="password"  value='<?=$item['password']?>'  />

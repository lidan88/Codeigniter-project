<?
$limit=30;
$sort=isset($_REQUEST['sort'])?$_REQUEST['sort']:"dropdown_item_id";
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
		...
		<div class="bread-crumb pull-left">
		  ...
		  <span class="divider">/</span> 
		  <a href="#" class="bread-current"><?=$dropdown_details['name']?> </a>
		  <span class="divider">/</span> 
		  <a href="/super_admin/dropdown_item/add/<?=$dropdown_details['dropdown_id']?>/"> &raquo; Add New</a>
		</div>
					...
					<div class="col-md-12">
						<div class="widget">
					        <div class="widget-head">
			                  <div class="pull-left">Items for <?=$dropdown_details['name']?></div>
			                	        ...
			                	        ?>
			                	            <tr onClick="javascript:toggleBgColor( this )">
			                	            	...
			                	            	<td align="center" valign="top" class="rowDark">
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-warning" href="/super_admin/dropdown_item/edit/<?=$row['dropdown_item_id']?>/"><i class="icon-pencil"></i> </a>
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-danger" href="javascript:confirm_delete('/super_admin/dropdown_item/do_delete/<?=$row['dropdown_item_id']?>/');"><i class="icon-remove"></i></a>
			                	            	</td>
			                	            </tr>
			                	        <? 	
			                	            }

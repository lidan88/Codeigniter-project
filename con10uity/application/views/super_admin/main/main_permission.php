<?
$limit=30;
$sort=isset($_REQUEST['sort'])?$_REQUEST['sort']:"permission_id";
...
<div class="content">
    ...
    <!-- Sidebar ends -->
  	...
  	<div class="mainbar">
		...
		<div class="bread-crumb pull-left">
		  ...
		  <span class="divider">/</span> 
		  <a href="/super_admin/permission/add/"> &raquo; Add New</a>
		</div>
					...
					<div class="col-md-12">
						<div class="widget">
					        <div class="widget-head">
			                  <div class="pull-left">Permission</div>
	...
	<td align="left" valign="top" class="rowDark"><?=isset($row['fgroup'])?$row['fgroup']:$row['group']?></td>
			                	            	...
			                	            	<td align="center" valign="top" class="rowDark">
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-warning" href="/super_admin/permission/edit/<?=$row['permission_id']?>/"><i class="icon-pencil"></i> </a>
			                	            		<a style="text-decoration:none" class="btn btn-xs btn-danger" href="javascript:confirm_delete('/super_admin/permission/do_delete/<?=$row['permission_id']?>/');"><i class="icon-remove"></i></a>
			                	            	</td>
			                	            </tr>
			                	        <? 	
			                	            }

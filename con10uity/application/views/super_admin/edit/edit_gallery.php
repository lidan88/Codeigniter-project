	          	            ...
	          	            <div class="col-md-12">
	          	              <div class="widget wgreen">
	          	                <div class="widget-head">
	          	                  <div class="pull-left">Edit gallery</div>
	          	                ...
	          	                <div class="widget-content">
	          	                  <div class="padd">
	          	                    ...
	          	                    <!-- Form starts.  -->
	          	                     <form class='form-horizontal' name='frm_edit_gallery' method='post' action='/super_admin/gallery/do_update/<?=$item['id']?>' onSubmit='return form_validation(this);' enctype='multipart/form-data'><table class="table table-bordered table-striped table-hover content" style="width:100%;" cellpadding="0" cellspacing="0"><input type='hidden' id='chaabee_post' name='chaabee_post' value=''><input type='hidden' id='id' name='id' value='<?=$item['id']?>'><tr>

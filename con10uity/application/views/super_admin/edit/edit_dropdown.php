    ...
    <!-- Sidebar ends -->
      ...
      <div class="page-head">
        ...
        <div class="bread-crumb pull-left">
          ...
          <a href="/super_admin/dropdown/main/"> View All dropdown </a>
          <span class="divider">/</span> 
	          	              ...
	          	              <div class="widget wgreen">
	          	                ...
	          	                <div class="widget-content">
	          	                  <div class="padd">
	          	                    ...
	          	                    <!-- Form starts.  -->
	          	                     <form class='form-horizontal' name='frm_edit_dropdown' method='post' action='/super_admin/dropdown/do_update/<?=$item['dropdown_id']?>' onSubmit='return form_validation(this);' enctype='multipart/form-data'>
	          	                     ...
	          	                     <input type='hidden' id='dropdown_id' name='dropdown_id' value='<?=$item['dropdown_id']?>'>

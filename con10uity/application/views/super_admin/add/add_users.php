	          	              ...
	          	              <div class="widget wgreen">
	          	                ...
	          	                <div class="widget-content">
	          	                  <div class="padd">
	          	                    ...
	          	                    <!-- Form starts.  -->
	          	                     <form class='form-horizontal' name='frm_add_users' method='post' action='/super_admin/users/do_add/' onSubmit='return form_validation(this);' enctype='multipart/form-data'>
										...
										<tr>
											...
											<td width='65%' class='capitalize'><input  class='form-control ' type='text' size=40 name='password'  value=''  /></td></tr><tr>
											...
											<td width='65%' class='capitalize'><input  class='form-control ' type='text' size=40 name='phone'  value=''  /></td></tr><tr>
											<td width='35%' class='capitalize'  valign='top' align='left'>Status:</td>
											<td width='65%' class='capitalize'><input name="status" type="radio" id="rstatus" value="ACTIVE" checked="checked" />&nbsp;ACTIVE&nbsp;<input name="status" type="radio" id="rstatus" value="INACTIVE" />&nbsp;INACTIVE&nbsp;</td></tr>
										<tr>

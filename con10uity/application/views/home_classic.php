		...
		<div class="container">
			...
			<div class="row">
				...
				<div class="pull-left menu_item">
					<a href="?v=classic_lib"><img src="/img/Library_48.png" alt="" />Library</a>
				</div>
				<div class="pull-left menu_item">
					<a href="?v=classic_admin"><img src="/img/Administration_48.png" alt="" />Administration</a>
				</div>
				<!--div class="pull-left menu_item">
					<a href="/admin/risk_assessment/main/"><img src="/img/RiskAssessment_48.png" alt="" />Risk Assessment</a>
				</div!-->
			<?
				$ctr=2;
				foreach($activatedLibs as $lib)
